...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'main',
        loadChildren: () => import('./modules/authorization/routes'),
      },
      ...
      {
        path: 'persons',
        loadChildren: () => import('./modules/persons/routes'),
      },
      ...
      {
        path: 'account',
        loadChildren: () => import('./modules/accounting/routes'),
      },
      ...
      {
        path: 'maps',
        loadChildren: () => import('./modules/gps/routes'),
      },
      ...
      {
        path: 'list',
        loadChildren: () => import('./modules/cruds/routes'),
      },
      ...
      {
        path: 'neuron',
        loadChildren: () => import('./modules/neuron/routes'),
      },
